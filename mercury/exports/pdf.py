...
def _footer(c: canvas.Canvas, page: int) -> None:
    ...
    c.drawCentredString(
        PAGE_W / 2, MARGIN - 24,
        f"Generated by Mercury Tracker \u00b7 {datetime.now().strftime('%m/%d/%Y %I:%M %p')}",
    )
...
def build_invoice_pdf(
    *,
    ...
    if notes:
        ...
        for i, text in enumerate(_wrap(notes, "Helvetica-Oblique", 8.5, PAGE_W - 2 * MARGIN)):
            c.drawString(MARGIN, y - i * 11, text)
